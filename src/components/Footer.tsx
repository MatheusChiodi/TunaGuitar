...
export default function Footer() {
  return (
    <footer className="no-print mt-auto hidden w-full flex-col items-center justify-between gap-4 border-t border-outline-variant bg-surface-lowest px-5 py-6 opacity-80 transition-opacity hover:opacity-100 md:flex md:flex-row md:px-10">
